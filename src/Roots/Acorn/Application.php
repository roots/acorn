...
class Application extends FoundationApplication
{
    ...
    {
        return ($this->bootstrapPath ?: $this->storagePath() . DIRECTORY_SEPARATOR . 'bootstrap') . ($path ? DIRECTORY_SEPARATOR . $path : $path);
    }
    ...
    {
        return is_file(ABSPATH . '/.maintenance');
    }
    ...
    public function make($abstract, array $parameters = [])
    {
        ...
        if (! $this->bound($abstract) && $provider = $this->instances['app.lazy']->getProvider($abstract)) {
